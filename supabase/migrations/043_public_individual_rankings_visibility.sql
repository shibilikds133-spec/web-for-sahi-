-- Add a persisted admin setting for public Individual rankings visibility.
-- This is additive and keeps existing leaderboard calculation and publish/hide flows intact.

ALTER TABLE public.festival_leaderboard_settings
ADD COLUMN IF NOT EXISTS show_individual_rankings boolean DEFAULT true;
...
REVOKE EXECUTE ON FUNCTION public.get_public_published_results(uuid, uuid) FROM anon, authenticated;
